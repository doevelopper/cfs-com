...
void GTestEventListener::OnTestPartResult( const testing::TestPartResult& test_part_result)
{
    ...
    {
    //LOG4CXX_TRACE(logger, "Test case failed : " << m_currentTestCaseName << " Test suite: " m_currentTestName << "
    //File: " << test_part_result.file_name() << " Line: " << test_part_result.line_number() << " Summary: " << test_part_result.summary());
...
{
    //LOG4CXX_TRACE(logger, "Test case finished: " << m_currentTestCaseName << " Test suite: " m_currentTestName <<
...
{
    //LOG4CXX_TRACE(logger, "Test case finished: Pass(" <<m_testCount << "), Failed(" << m_failedTestCount << ")");
}
