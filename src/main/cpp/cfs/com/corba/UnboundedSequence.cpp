...
template <class T>
T*
UnboundedSequence<T>::allocbuf (ULong nelems)
{
    return new T [nelems];
}
...
template <class T>
void
UnboundedSequence<T>::freebuf (T * buffer)
{
...
template <class T>
void
UnboundedSequence<T>::copy( const UnboundedSequence<T>& seq)
{
    if (this == &seq) return;
...
template <class T>
ULong
UnboundedSequence<T>::maximum () const
{
    return (m_max);
}
...
template <class T>
ULong
UnboundedSequence<T>::length () const
{
    return (m_length);
}
...
template <class T>
void
UnboundedSequence<T>::length (ULong length)
{
    if (length > m_max)
    {
...
template <class T>
T&
UnboundedSequence<T>::operator [] (ULong index)
{
...
template <class T>
const T&
UnboundedSequence<T>::operator [] (ULong index) const
{
    assert (index < m_length);
...
template <class T>
const T&
UnboundedSequence<T>::get (ULong index) const
{
    assert (index < m_length);
