...
// TAO_IDL - Generated from
// /tmp/ACE_TAO/TAO/TAO_IDL/be/be_visitor_structure/cdr_op_cs.cpp:49

TAO_BEGIN_VERSIONED_NAMESPACE_DECL

::CORBA::Boolean operator<< (
    TAO_OutputCDR &strm,
    const cfs::com::Messenger::Message &_tao_aggregate)
{
  return
...
::CORBA::Boolean operator>> (
    TAO_InputCDR &strm,
    cfs::com::Messenger::Message &_tao_aggregate)
{
  return
